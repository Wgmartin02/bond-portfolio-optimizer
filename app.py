...
def run_ai_portfolio_optimization():
    ...
    st.write("""
    This application helps you optimize a bond ETF portfolio. Select up to 4 bond ETFs from the list,
    ...
    try:
        with st.spinner("Fetching ETF data and analyzing portfolio..."):
            ...
            etf_names = [f"{ticker}" for ticker in selected_etfs]
            ...
            with col3:
                ...
                if "TLT" in selected_etfs or "VGLT" in selected_etfs or "BLV" in selected_etfs:
                    interest_rate_sensitivity = "High"
                elif "SHY" in selected_etfs or "VCSH" in selected_etfs or "BSV" in selected_etfs:
